...
if(isset($_POST['btnsrc']))
		{
$dt=$_POST["src"];
$sql = "select * from record where  place like '$dt%' order by r_id desc ";
...
$sql= "select * from record where  place like '$dt%' order by r_id desc LIMIT $record_index, $limit";
...
$sql = "SELECT COUNT(*) FROM record where  place like '$dt%' order by r_id desc"; 
...
$total_pages = ceil($total_records / $limit);  
   ...
   echo "<ul>"; 
   echo "<li><a href='search.php?page=".($page-1)."'>Previous</a></li>"; 
for ($i=1; $i<=$total_pages; $i++) {  

 

  
    echo "<li><a style='width:10%;' href='search.php?page=".$i."'>".$i."</a></li>";
