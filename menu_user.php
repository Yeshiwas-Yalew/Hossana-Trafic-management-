...
<div class="loginpad">
<form name="search" method="post" action="search_type.php">
<select  name="Acc_Type" required id="txt">
			<option value="">Select Type</option>
				...
				{ 
					  ?>
					      <option value="<?php echo $rows['Acc_Type']?>"><?php echo $rows['Acc_Type']?></option>
...
<a style="position: relative;margin-left:40%;color:white;font-family:bold;padding-top:0%;font-family: Helvetica, Arial, sans-serif;
	font-weight: bold;" href="logout.php">Log out</a>
		...
		<div style="margin-left:-5%;margin-top:-1%;"><?php include'necessary/top_title_admin.php';?> </div>
