		...
		<div class="container-fluid">
			...
			<form method="post" action="" id="manage-user" style="color:black;height:auto;">	
				...
				<div class="form-group col-6">
					...
					<input type="text" name="type" id="username" class="form-control" value="<?php echo $Acc_type; ?>" required  autocomplete="off">
				</div>
				<div class="form-group col-6">
					<label for="username">Account Status</label>
					<input type="status" name="status" id="username" class="form-control" value="<?php echo $status; ?>" required  autocomplete="off">
				</div>
				<!--<div class="form-group col-6">
...
/*if($type==1)
	...
	$type="Staff";*/
//$Status="Active";
		$sql = "UPDATE admin SET FName='$fname',LName='$lname',SEX='$sex',Phone='$phone_number',Email='$email',Acc_type='$type',ad_username='$ad_usrname',ad_password='$ad_password',Status='$Status' Where ad_id='$ctrl'";
